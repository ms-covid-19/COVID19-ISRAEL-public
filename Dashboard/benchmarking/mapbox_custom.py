...
mapbox_access_token = "pk.eyJ1IjoiZGtvbG9ib2siLCJhIjoiY2s4Y2w5ZzRwMG1zYjNobHZvMzlvNjFvaCJ9.93zlHHMTn2ehf3JRSDme9w"
mapbox_style = "mapbox://styles/dkolobok/ck8g63kqa3o2o1iofr43zygum"

# with open(os.path.join('c:/users/dkolobok/cache/style.json')) as json_file:
#     mapbox_style = json.load(json_file)
...
if __name__ == '__main__':
    ...
    centers = pd.read_feather(os.path.join(DASH_CACHE_DIR, 'cities_centers.feather'))
    data = [
        dict(
            lat=centers["lat"],
            lon=centers["lon"],
    ...
    fig_choropleth = go.Figure(data=data, layout=layout)
